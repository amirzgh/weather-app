...
public class WeatherInfo {
    ...
    public static void getWeatherInfoByCoordinates(double latitude, double longitude, Context context, Handler handler) {
        Thread thread = new Thread() {
            @Override
            public void run() {
                ArrayList<String> cityWeatherInfo = new ArrayList<>();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            bundle.putStringArrayList("cityWeatherInfo", cityWeatherInfo);
